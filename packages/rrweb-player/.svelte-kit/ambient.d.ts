...
declare module '$env/static/private' {
	...
	export const npm_config_user_name: string;
	...
	export const npm_config_puppeteer_download_base_url: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_config_puppeteer_download_base_url: string;
